...
|2| Примеры использования Word2Vec, Doc2Vec и других 2Vec | семинар |
|3| LSTM, GRU | лекция |
|3| LSTM, GRU | семинар |
|4| Автоэнкодеры | интерактивная лекция |
|5| Генеративные состязательные сети. Часть 1 (GANs) | интерактивная лекция |
|6| Генеративные состязательные сети. Часть 2 (GANs) | интерактивная лекция |
|7| Введение в Reinforcement Learning | лекция |
|7| Обучаем своего умного агента-игрока с помощью RL | семинар |
|8| Бонус  | TBA |
